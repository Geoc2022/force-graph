...
* [Self links with Adjusted Rotation](https://vasturiano.github.io/force-graph/example/curved-links-with-rotation) ([source](https://github.com/vasturiano/force-graph/blob/master/example/curved-links-with-rotation/index.html))
...
| <b>linkCurveRotation</b>([<i>num</i>, <i>str</i> or <i>fn</i>]) | Link object accessor function, attribute or a numeric constant for the rotation of the link's curve, in radians. For regular (non-self-referencing) links, this rotates the curvature direction about the link. For self-referencing links, this rotates the loop orientation around the node. | 0 |
